...
// Single-Ended режим на A0 (относительно GND), усиление ±2.048V, 128 SPS
//Для single-ended измерений максимальное напряжение = +2.048V (относительно GND)
//Отрицательные напряжения не измеряются в single-ended режиме
//Значение ADC будет в диапазоне 0...32767 (положительные значения)
#define ADS1115_CONFIG_SINGLE_A0 0xC580
